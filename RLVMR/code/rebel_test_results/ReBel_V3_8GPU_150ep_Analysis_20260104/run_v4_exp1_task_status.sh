#!/bin/bash
# =============================================================================
# V4 实验 1: task_status 分组 + task_aware (推荐方案)
# =============================================================================
#
# 改进点:
#   - belief_granularity: "task_status" (基于结构化字段，100%覆盖)
#   - task_aware_grouping: true (任务感知分组)
...
EXPERIMENT_NAME="rebel_v4_exp1_task_status_$(date +%Y%m%d_%H%M%S)"
...
echo ""
echo "═══════════════════════════════════════════════════════════════════"
echo "  V4 实验 1: task_status 分组 + task_aware"
echo "═══════════════════════════════════════════════════════════════════"
echo ""
echo "改进点:"
echo "  - belief_granularity: task_status (结构化字段，100%覆盖)"
echo "  - task_aware_grouping: true"
echo ""
echo "预期效果:"
echo "  - Groups/Batch: 40-50% → <15%"
echo "  - 单样本组: 68.5% → <30%"
echo ""
echo "配置:"
...
python3 -m verl.trainer.main_ppo \
    ...
    algorithm.rebel.belief_granularity="task_status" \
