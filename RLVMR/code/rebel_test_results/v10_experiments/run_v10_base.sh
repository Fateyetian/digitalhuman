...
# ReBel V10 通用基础训练脚本
# =============================================================================
# 所有消融实验的统一入口。通过环境变量控制实验配置。
#
# 必需环境变量:
#   EXP_ID          - 实验编号 (A1/A2/B1/C1/C2/D1/E1)
#   EXP_NAME        - 实验名称 (如 grpo_baseline)
#   ADV_ESTIMATOR   - advantage 估计器 (grpo/gigpo/rebel)
#   USE_REBEL_PROMPT - 是否使用 <belief> 提示格式 (true/false)
#
# 可选环境变量 (有默认值):
#   USE_TRAINING_TRICKS  - 是否启用训练 tricks (true/false, 默认 false)
...
#   DECAY_METHOD         - 衰减方法 (cosine/linear/exponential, 默认 cosine)
#   NUM_GPUS             - GPU 数量 (默认 4)
#   EPOCHS               - 训练轮次 (默认 100)
#   SEED                 - 随机种子 (默认 42)
#   MODEL_PATH           - 起始模型路径 (默认自动查找)
# =============================================================================
...
# ======================== 实验标识 ========================
EXP_ID=${EXP_ID:?"ERROR: EXP_ID is required (A1/A2/B1/C1/C2/D1/E1)"}
...
# ======================== 输出路径 ========================
RESULTS_BASE="/fs-computility-new/UPDZ03_chengjun/huangsijie.p/rebel_results/v10_experiments"
...
# ======================== 打印配置 ========================
echo "═══════════════════════════════════════════════════════════════════"
echo "  ReBel V10 消融实验: ${EXP_ID} - ${EXP_NAME}"
echo "═══════════════════════════════════════════════════════════════════"
echo ""
echo "实验配置:"
echo "  - ID:               ${EXP_ID}"
...
echo "  - 训练 Tricks:      ${USE_TRAINING_TRICKS}"
...
BASE_ARGS=(
    ...
    "trainer.project_name=ReBel_V10_Ablation"
